      ...
      <div className="flex items-center justify-center ">
        <div className="flex flex-col md:flex-row w-[70%] items-center space-y-4 ">
          <div className="flex-col space-y-4 text-center md:w-1/2 w-[80%]">
            <div className="text-fuchsia-600 text-xl font-medium">YMCVC</div>
            <div className="text-5xl font-medium">YMC Ventures Corporation</div>
            <div className="text-gray-500">
              YMC Ventures Corporation engages in cement retail distribution and
              diesel transactions.
            </div>
            <div className="flex items-center justify-center">
